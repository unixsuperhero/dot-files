# x509
# Autogenerated from man page /usr/share/man/man1/x509.1ssl
# using Type1
...
complete -c x509 -o engine --description 'specifying an engine (by it\'s unique id string)… [See Man Page]'
