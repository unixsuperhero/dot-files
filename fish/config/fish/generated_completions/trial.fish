...
complete -c trial -l debugger --description 'Specifies the debugger to use when the --debug … [See Man Page]'
...
complete -c trial -l help-order --description 'Print a list of possible orders that TestCase t… [See Man Page]'
...
complete -c trial -l order --description 'Specify what order to run the individual test m… [See Man Page]'
...
complete -c trial -l temp-directory --description 'WARNING: Do not use this option unless you know… [See Man Page]'
