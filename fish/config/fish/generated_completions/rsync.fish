...
complete -c rsync -l size-only --description 'Normally rsync will not transfer any files that… [See Man Page]'
complete -c rsync -l modify-window --description 'When comparing two timestamps, rsync treats the… [See Man Page]'
complete -c rsync -s c -l checksum --description 'This forces the sender to checksum every regula… [See Man Page]'
...
complete -c rsync -l inplace --description 'This causes rsync not to create a new copy of t… [See Man Page]'
...
complete -c rsync -s K --description 'This option causes the sending side to treat a … [See Man Page]'
complete -c rsync -l force --description 'See also --keep-dirlinks for an analogous optio… [See Man Page]'
complete -c rsync -l keep-dirlinks --description 'This option causes the receiving side to treat … [See Man Page]'
...
complete -c rsync -l executability --description 'This option causes rsync to preserve the execut… [See Man Page]'
...
complete -c rsync -s S --description 'Try to handle sparse files efficiently so they … [See Man Page]'
complete -c rsync -s n -l dry-run --description 'This tells rsync to not do any file transfers, … [See Man Page]'
complete -c rsync -s W -l whole-file --description 'With this option the incremental rsync algorith… [See Man Page]'
...
complete -c rsync -l delete-after --description 'Request that the file-deletions on the receivin… [See Man Page]'
...
complete -c rsync -s B -l block-size --description 'This forces the block size used in the rsync al… [See Man Page]'
...
complete -c rsync -s y -l fuzzy --description 'This option tells rsync that it should look for… [See Man Page]'
...
complete -c rsync -l link-dest --description 'This option behaves like --copy-dest, but uncha… [See Man Page]'
...
complete -c rsync -s i --description 'Requests a simple itemized list of the changes … [See Man Page]'
...
complete -c rsync -l delay-updates --description 'For the purposes of the daemon-config\'s "refuse… [See Man Page]'
complete -c rsync -l 'partial.' --description 'refusal of the --partial option can be used to … [See Man Page]'
complete -c rsync -s m -l prune-empty-dirs --description 'This option tells the receiving rsync to get ri… [See Man Page]'
...
complete -c rsync -l list-only --description 'This option will cause the source files to be l… [See Man Page]'
...
complete -c rsync -s E -l extended-attributes --description 'Apple specific option to copy extended attribut… [See Man Page]'
